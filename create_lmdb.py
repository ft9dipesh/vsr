...
def REDS(mode):
    ...
    if mode == 'train_sharp':
        ...
        img_folder = 'data/dataset/train_blur_bicubic'
        lmdb_save_path = 'data/dataset/train_blur_bicubic_wval.lmdb'
        H_dst, W_dst = 180, 320
    elif mode == 'train_blur':
        img_folder = 'data/dataset/train_blur'
        lmdb_save_path = 'data/dataset/train_blur_wval.lmdb'
        H_dst, W_dst = 720, 1280
    elif mode == 'train_blur_comp':
        img_folder = 'data/dataset/train_blur_comp'
        lmdb_save_path = 'data/dataset/train_blur_comp_wval.lmdb'
        H_dst, W_dst = 720, 1280
    elif mode == 'train_sharp_flowx4':
        img_folder = 'data/dataset/train_sharp_flowx4'
        lmdb_save_path = 'data/dataset/train_sharp_flowx4.lmdb'
        H_dst, W_dst = 360, 320
    n_thread = 40
    ########################################################
    if not lmdb_save_path.endswith('.lmdb'):
